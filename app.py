...
class GameTracker(ctk.CTk):
    ...
    def show_mario_input(self):
        ...
        # اللمسة الأخيرة: الملحوظة الأنيقة أسفل الزر
    ...
    def setup_tab_ui(self, status):
        ...
        tab.img = ctk.CTkLabel(tab, text="", width=self.img_w, height=self.img_h, corner_radius=15, fg_color="#000000")
        tab.img.pack(pady=15)
        tab.name = ctk.CTkLabel(tab, text="EMPTY", font=("Segoe UI", 35, "bold"))
