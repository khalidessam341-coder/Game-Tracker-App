...
class GameTracker(ctk.CTk):
    def __init__(self):
        ...
        # كبرت نافذة البرنامج شوية عشان القائمة الجديدة تاخد راحتها والشكل ميبقاش مزنوق
    ...
    def setup_tab_ui(self, status):
        ...
        # تقسيم الواجهة لقائمة ألعاب على الشمال وصورة كبيرة على اليمين
        tab.grid_columnconfigure(0, weight=1) # قائمة الألعاب
        tab.grid_columnconfigure(1, weight=3) # الصورة الرئيسية
        tab.grid_rowconfigure(0, weight=1)

        # 1. القائمة الجانبية للألعاب (Scrollable)
    ...
    # دالة جديدة لاختيار اللعبة عند الضغط عليها من القائمة
